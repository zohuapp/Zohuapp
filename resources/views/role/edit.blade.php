                                                        ...
                                                        <table class="table table-striped">
                                                               ...
                                                               <tbody>
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox" id="god-eye"
                                                                                           value="map" name="god-eye[]"
                                                                                           class="permission"
                                                                                           {{in_array('map',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="roles[]"
                                                                                           class="permission"
                                                                                           {{in_array('role.save',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id
                                                                                    == 1 ? 'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="roles[]"
                                                                                           class="permission"
                                                                                           {{in_array('role.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id
                                                                                    == 1 ? 'disabled' : ''}}>
                                                                                    <label class=" contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="roles[]"
                                                                                           class="permission"
                                                                                           {{in_array('role.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="admins[]"
                                                                                           class="permission"
                                                                                           {{in_array('admin.users',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="admins[]"
                                                                                           class="permission"
                                                                                           {{in_array('admin.users.create',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           id="admin-edit"
                                                                                           value="admin.users.edit"
                                                                                           name="admins[]"
                                                                                           class="permission"
                                                                                           {{in_array('admin.users.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           id="user-list" value="users"
                                                                                           name="users[]"
                                                                                           class="permission"
                                                                                           {{in_array('users',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="users[]"
                                                                                           class="permission"
                                                                                           {{in_array('users.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="users[]"
                                                                                           class="permission"
                                                                                           {{in_array('users.view',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="drivers[]"
                                                                                           class="permission"
                                                                                           {{in_array('drivers.create',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="drivers[]"
                                                                                           class="permission"
                                                                                           {{in_array('drivers.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="drivers[]"
                                                                                           class="permission"
                                                                                           {{in_array('drivers.view',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           id="drivers-delete"
                                                                                           value="drivers.delete"
                                                                                           name="drivers[]"
                                                                                           class="permission"
                                                                                           {{in_array('drivers.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox" id="report"
                                                                                           ...
                                                                                           name="reports[]"
                                                                                           class="permission"
                                                                                           {{in_array('report.index',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="category[]"
                                                                                           class="permission"
                                                                                           {{in_array('categories',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="category[]"
                                                                                           class="permission"
                                                                                           {{in_array('categories.create',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="category[]"
                                                                                           class="permission"
                                                                                           {{in_array('categories.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="category[]"
                                                                                           class="permission"
                                                                                           {{in_array('categories.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="brands[]"
                                                                                           class="permission"
                                                                                           {{in_array('brands.create',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class=" control-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="brands[]"
                                                                                           class="permission"
                                                                                           {{in_array('brands.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class=" control-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="brands[]"
                                                                                           class="permission"
                                                                                           {{in_array('brands.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           id="foods-list" value="items"
                                                                                           name="items[]"
                                                                                           class="permission"
                                                                                           {{in_array('items',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="items[]"
                                                                                           class="permission"
                                                                                           {{in_array('items.create',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="items[]"
                                                                                           class="permission"
                                                                                           {{in_array('items.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="items[]"
                                                                                           class="permission"
                                                                                           {{in_array('items.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="item-attribute[]"
                                                                                           class="permission"
                                                                                           {{in_array('attributes',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           value="attributes.create"
                                                                                           name="item-attribute[]"
                                                                                           class="permission"
                                                                                           {{in_array('attributes.create',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           id="attributes-edit"
                                                                                           value="attributes.edit"
                                                                                           name="item-attribute[]"
                                                                                           class="permission"
                                                                                           {{in_array('attributes.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="item-attribute[]"
                                                                                           class="permission"
                                                                                           {{in_array('attributes.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           id="orders-print"
                                                                                           value="vendors.orderprint"
                                                                                           name="orders[]"
                                                                                           class="permission"
                                                                                           {{in_array('vendors.orderprint',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="orders[]"
                                                                                           class="permission"
                                                                                           {{in_array('orders.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="orders[]"
                                                                                           class="permission"
                                                                                           {{in_array('orders.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           id="pending-orders-list"
                                                                                           value="pending.orders"
                                                                                           name="pending_orders[]"
                                                                                           class="permission"
                                                                                           {{in_array('pending.orders',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class=" control-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           id="pending-orders-delete"
                                                                                           value="pending.orders.delete"
                                                                                           name="pending_orders[]"
                                                                                           class="permission"
                                                                                           {{in_array('pending.orders.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="coupons[]"
                                                                                           class="permission"
                                                                                           {{in_array('coupons.create',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="coupons[]"
                                                                                           class="permission"
                                                                                           {{in_array('coupons.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="coupons[]"
                                                                                           class="permission"
                                                                                           {{in_array('coupons.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           class="permission"
                                                                                           {{in_array('notification',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="general-notifications[]"
                                                                                           class="permission"
                                                                                           {{in_array('notification.send',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="general-notifications[]"
                                                                                           class="permission"
                                                                                           {{in_array('notification.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           class="permission"
                                                                                           {{in_array('app.notification',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="control-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           id="app-notification-view"
                                                                                           value="app.notification.view"
                                                                                           name="app-notifications[]"
                                                                                           class="permission"
                                                                                           {{in_array('app.notification.view',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="control-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           id="app-notification-delete"
                                                                                           value="app.notification.delete"
                                                                                           name="app-notifications[]"
                                                                                           class="permission"
                                                                                           {{in_array('app.notification.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           class="permission"
                                                                                           {{in_array('wallet.transaction',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="control-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="banners[]"
                                                                                           class="permission"
                                                                                           {{in_array('banners.create',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class=" control-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="banners[]"
                                                                                           class="permission"
                                                                                           {{in_array('banners.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class=" control-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="banners[]"
                                                                                           class="permission"
                                                                                           {{in_array('banners.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class=" control-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           id="email-template"
                                                                                           value="email-templates.index"
                                                                                           name="email-template[]"
                                                                                           class="permission"
                                                                                           {{in_array('email-templates.index',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           id="email-template-edit"
                                                                                           value="email-templates.edit"
                                                                                           name="email-template[]"
                                                                                           class="permission"
                                                                                           {{in_array('email-templates.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="cms[]"
                                                                                           class="permission"
                                                                                           {{in_array('cms.create',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class=" control-label2"
                                                                                           for="cms-create">{{trans('lang.create')}}</label>
                                                                                    <input type="checkbox" id="cms-edit"
                                                                                           value="cms.edit" name="cms[]"
                                                                                           class="permission"
                                                                                           {{in_array('cms.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class=" control-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="cms[]"
                                                                                           class="permission"
                                                                                           {{in_array('cms.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class=" control-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           id="global-setting"
                                                                                           value="settings.app.globals"
                                                                                           name="global-setting[]"
                                                                                           class="permission"
                                                                                           {{in_array('settings.app.globals',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="currency[]"
                                                                                           class="permission"
                                                                                           {{in_array('currencies',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           id="currency-create"
                                                                                           value="currencies.create"
                                                                                           name="currency[]"
                                                                                           class="permission"
                                                                                           {{in_array('currencies.create',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="currency[]"
                                                                                           class="permission"
                                                                                           {{in_array('currencies.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="currency[]"
                                                                                           class="permission"
                                                                                           {{in_array('currencies.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="payment-method[]"
                                                                                           class="permission"
                                                                                           {{in_array('payment-method',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox" id="tax-list"
                                                                                           value="tax" name="tax[]"
                                                                                           class="permission"
                                                                                           {{in_array('tax',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="tax[]"
                                                                                           class="permission"
                                                                                           {{in_array('tax.create',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox" id="tax-edit"
                                                                                           value="tax.edit" name="tax[]"
                                                                                           class="permission"
                                                                                           {{in_array('tax.edit',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="tax[]"
                                                                                           class="permission"
                                                                                           {{in_array('tax.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           id="delivery-charge"
                                                                                           value="settings.app.deliveryCharge"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           id="language-list"
                                                                                           value="settings.app.languages"
                                                                                           name="language[]"
                                                                                           class="permission"
                                                                                           {{in_array('settings.app.languages',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           id="language-create"
                                                                                           value="settings.app.languages.create"
                                                                                           name="language[]"
                                                                                           class="permission"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           id="language-edit"
                                                                                           value="settings.app.languages.edit"
                                                                                           name="language[]"
                                                                                           class="permission"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                           id="language-delete"
                                                                                           value="settings.app.languages.delete"
                                                                                           name="language[]"
                                                                                           class="permission"
                                                                                           {{in_array('settings.app.languages.delete',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           class="permission"
                                                                                           {{in_array('landingpage',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class=" control-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox" id="terms"
                                                                                           ...
                                                                                           name="terms[]"
                                                                                           class="permission"
                                                                                           {{in_array('termsAndConditions',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox" id="privacy"
                                                                                           ...
                                                                                           name="privacy[]"
                                                                                           class="permission"
                                                                                           {{in_array('privacyPolicy',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class="contol-label2"
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <input type="checkbox" id="refund"
                                                                                           ...
                                                                                           name="refund[]"
                                                                                           class="permission"
                                                                                           {{in_array('refundPolicy',$permissions)
                                                                                           ? "checked" : "" }}
                                                                                           {{$roles->id == 1 ?
                                                                                    'disabled' : ''}}>
                                                                                    <label class=" control-label2"
