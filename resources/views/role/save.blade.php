                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                @foreach (permissions_array() as $permissions => $routes)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="{{ $permissions }}" value="{{ $routes }}"
                                                                name="routes[]" class="permission">
                                                            <label class="control-label2" for="{{ $permissions }}">
                                            ...
                                            {{-- <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="categories-delete"
                                                            value="categories.delete" name="category[]"
                                                            class="permission">
                                                        <label class="contol-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="brands" value="brands"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="foods-list" value="items"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="pending-orders-list"
                                                            value="pending.orders" name="pending_orders[]"
                                                            class="permission">
                                                        <label class=" control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="currency-delete"
                                                            value="currencies.delete" name="currency[]"
                                                            class="permission">
                                                        <label class="contol-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="landingpageTemplate"
                                                            value="landingpage" name="landingpage-template[]"
                                                            class="permission">
