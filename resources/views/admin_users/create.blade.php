    ...
    <div class="page-wrapper">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{!! route('admin.users') !!}">{{trans('lang.create_admin')}}</a>
                    </li>
                </ol>
            </div>
        ...
        <div class="profile-form">
            ...
            <div class="card-body">
                ...
                <div class="column">
                    <form method="post" action="{{ route('admin.users.store') }}" id="submitForm">
                        @csrf
                            ...
                            <div class="restaurant_payout_create-inner">
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class=" col-6 form-control" name="name" value="{{ old('name') }}"
                                                   >
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class=" col-6 form-control" name="email" value="{{ old('email') }}"
                                                   id="email_address">
                        ...
                        <div class="form-group col-12 text-center btm-btn">
                            <button type="button" class="btn btn-primary  save_user_btn save-form-btn" id="save_user_btn"><i
