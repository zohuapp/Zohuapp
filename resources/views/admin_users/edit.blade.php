    ...
    <div class="page-wrapper">
        ...
        <div class="profile-form">
            ...
            <div class="card-body">
                ...
                <div class="column">
                    <form method="post" action="{{ route('admin.users.update',$user->id) }}"  id="submitForm">
                        @csrf
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class=" col-6 form-control"
                                                   value="<?php echo $user->email; ?>" name="email" id="email_address">
                        ...
                        <div class="form-group col-12 text-center btm-btn">
                            <button type="button" class="btn btn-primary  save_user_btn edit-form-btn" id="save_user_btn"><i
