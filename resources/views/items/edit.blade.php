    ...
    function handleFileSelect(evt, vid) {
        ...
        reader.onload = (function (theFile) {
            return function (e) {
                ...
                productImagesCount++;
                photos_html = '<span class="image-item" id="photo_' + productImagesCount + '"><span class="remove-btn" data-id="' + productImagesCount + '" data-img="' + filePayload + '" data-status="new"><i class="fa fa-remove"></i></span><img class="rounded" width="50px" id="" height="auto" src="' + filePayload + '"></span>'
        ...
        if (item_attribute.length > 0) {
            ...
            if (attributeSet.length > 0) {
                ...
                $.each(variants, function (index, variant) {
                    ...
                    html += '<td>';
                    var check_variant_price = $('#price_' + variant).val() ? $('#price_' + variant).val() : variant_price;
