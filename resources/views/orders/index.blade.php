    ...
    $(document).ready(function () {
        ...
        const table = $('#orderTable').DataTable({
            ...
            ajax: async function (data, callback, settings) {
                ...
                const orderableColumns = getOrderableColumns(getId, driverID, userID, checkDeletePermission);
                    ...
                    await Promise.all(querySnapshot.docs.map(async (doc) => {
                        ...
                        if (searchValue) {
                            ...
                            if (
                                ...
                                (driver && driver.toLowerCase().includes(searchValue)) ||
            ...
            order: (getId != '' || driverID || userID) ? (checkDeletePermission ? [[3, 'desc']] : [[2, 'desc']]) : (checkDeletePermission ? [[4, 'desc']] : [[3, 'desc']]),
            columnDefs: [
                {
                    targets: (getId != '' || driverID || userID) ? (checkDeletePermission ? [3] : [2]) : (checkDeletePermission ? [4] : [3]),
                    type: 'date',
                ...
                {
                    orderable: false,
                    targets: (getId != '' || driverID || userID) ? (checkDeletePermission ? [0, 5, 6] : [4, 5]) : (checkDeletePermission ? [0, 6, 7] : [5, 6])
                }
            ],
            "language": {
        ...
        if (userID) {
            if (val.hasOwnProperty("driverID") && val.driverID) {
                ...
                if (driver) {
                    ...
                    html.push('<a  data-url="' + diverRoute + '" href="'+ diverRoute +'" class="redirecttopage">' + driver + '</a>');
                } else {
