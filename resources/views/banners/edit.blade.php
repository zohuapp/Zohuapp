...
<script>
    ...
    $(document).ready(function () {
        ...
        ref.get().then(async function (snapshots) {
            ...
            if (menuItems.hasOwnProperty('redirect_type') && menuItems.redirect_type!='' ) {
    ...
    $(".edit-form-btn").click(function () {
        ...
        if (title == '') {
            ...
            if (checkFlagRedirection == "external_link") {
                $(".error_top").append("<p>{{trans('lang.external_link_error')}}</p>");

            } else {
                $(".error_top").append("<p>{{trans('lang.product_error')}}</p>");
